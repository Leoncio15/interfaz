...
function App() {
  ...
  const handleSliderChange = (e) => {
    ...
    axios.post('https://interfaz.fly.dev/actualizar-slider', { sliderValue: newValue })
      .then(response => {
  ...
  useEffect(() => {
    const fetchData = () => {
      axios.get('https://interfaz.fly.dev/datos') // Asegúrate de que esta URL sea la correcta
        .then(response => {
