...
function App() {
  ...
  const handleSliderChange = (e) => {
    ...
    axios.post('http://192.168.1.6:5003/actualizar-slider', { sliderValue: newValue })
      .then(response => {
  ...
  useEffect(() => {
    const fetchData = () => {
      axios.get('http://172.29.17.112:5003/datos') // Asegúrate de que esta URL sea la correcta
        .then(response => {
